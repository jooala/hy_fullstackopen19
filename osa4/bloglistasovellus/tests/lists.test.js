...
describe("favorite blog", () => {
  test("Title matches the most liked blog's title", () => {
    const result = listHelper.favoriteBlog(blogs)
    expect(result.title).toEqual("Canonical string reduction")  
  })
  
  test("Author matches the most liked blog's author", () => {
    const result = listHelper.favoriteBlog(blogs)
    expect(result.author).toEqual("Edsger W. Dijkstra")  
  })

  test("Amount of likes matches the most liked blog's likes", () => {
    const result = listHelper.favoriteBlog(blogs)
...
describe("author with most blogs", () => {
  ...
  test("author with most blogs when list only 1 blog", () => {
